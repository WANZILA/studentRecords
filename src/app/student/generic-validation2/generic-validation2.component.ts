...
import { PasswordMatcher } from '../../shared/shared/password-matcher';
import { GenericValidator } from '../../shared/shared/generic-validator';


@Component({
  selector: 'app-generic-validation2',
  templateUrl: './generic-validation2.component.html',
  styleUrls: ['./generic-validation2.component.css']
})
export class GenericValidation2Component implements OnInit, AfterViewInit {
