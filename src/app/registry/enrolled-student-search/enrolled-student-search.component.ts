...
@Component({
  selector: 'app-enrolled-student-search',
  templateUrl: './enrolled-student-search.component.html',
  styleUrls: ['./enrolled-student-search.component.css']
})
export class EnrolledStudentSearchComponent implements OnInit {
     ...
     pageTitle = "Search Enrolled Students";
     errorMessage: string;
